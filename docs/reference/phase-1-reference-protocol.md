...
evidence are in the **acquisition inventory** (`manifests/phase1-discovery-v1-pdf-acquisition.json`, local-only evidence omitted from Git).
...
ignored **local review packet** (`local-reference/phase1-discovery-v1/review-draft.md`, local-only evidence omitted from Git).
